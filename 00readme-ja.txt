...
さらに 4.1 でのかなり大きな機能追加は，プラグインによる拡張機能の実装
です．デコーダを簡単に実行時に拡張することができます．
ディレクトリ "plugin" 以下に，サンプルのソースコードが含まれており，コ
ンパイルしてテストできるようになっています．ソースコードには
定義すべき各関数の詳細がコメントで書かれていますので，参考にしてください．
